...
class TFirebaseException implements Exception {
  ...
  String get message {
    ...
    return 'The supplied credential is malformed or has assistance.';
    ...
    case 'internet-error':
    return 'An internet authentication error occurred. Please try again later.';
    case 'require-recent-login':
    return 'This operation is sensitive ande required recent authentication. Please log in again.';
    case 'quota-exceeded':
    ...
    case 'invalid-sender':
      ...
      case 'credential-already-in-use':
        return 'This credential is a already associated with a different user account.';
      default:
